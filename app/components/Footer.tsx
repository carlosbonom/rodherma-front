          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2 justify-center sm:justify-start">
                ...
                <span className="text-sm sm:text-base"><a href="https://maps.app.goo.gl/DaL8jRJ4tH9kTYg39" target="_blank">Los Peumos 12175, El Bosque</a></span>
              </li>
              <li className="flex items-start gap-2 justify-center sm:justify-start">
                ...
                <span className="text-sm sm:text-base break-all">
                    manuelrodriguezguitarras@gmail.com
                </span>
              </li>
              <li className="flex items-center gap-2 justify-center sm:justify-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-orange-500" viewBox="0 0 20 20" fill="currentColor">
                ...
                <span className="text-sm sm:text-base">+56 9 9467 4072</span>
              </li>
            </ul>
          </div>
