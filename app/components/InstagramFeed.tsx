...
const images = [
  '/images/categoria-01.jpg',
  '/images/categoria-02.jpg',
  '/images/categoria-03.jpg',
  '/images/categoria-04.jpg',
      ...
      <div className="scroll-container">
        <div className="flex gap-4 animate-scroll">
          {images.map((image, index) => (
            <div
              key={index}
              className="relative w-[250px] h-[250px] flex-shrink-0 group overflow-hidden rounded-xl"
            >
              <Image
                src={image}
                alt="Instagram feed"
